  ...
  (function () {
    ...
    var translations = {
      ru: {
        ...
        'collab-h2': 'Полный цикл производства',
        'collab-d2': 'Сценарий → съёмка → монтаж → трендовая музыка. Всё под ключ',
        'collab-h3': 'Органическое продвижение',
        'collab-d3': 'Размещаем контент в наших личных аккаунтах для нативного охвата без рекламной пометки',
        ...
        'chemistry-text': '<span class="ct-intro">Люди подписываются на нас не за красивую картинку —<br>а за настоящую связь между нами.</span><span class="ct-values">Любовь&nbsp;&nbsp;·&nbsp;&nbsp;Доверие&nbsp;&nbsp;·&nbsp;&nbsp;Семейные ценности</span><span class="ct-conclusion">Это то, что бренды пытаются передать через актёров,<br>а у нас это реальность.<br>Зрители это чувствуют — и <em>верят.</em></span>',
        'cf-name': 'Ваше имя',
      ...
      en: {
        ...
        'collab-h1': 'UGC look, ad-level impact',
        'collab-d1': 'Content that looks organic — and performs like professional advertising',
        'collab-h2': 'Full production cycle',
        'collab-d2': 'Script → shoot → edit → trending music. Fully turnkey',
        'collab-h3': 'Organic reach',
        'collab-d3': 'We post content on our personal accounts for native reach without sponsored tags',
