  ...
  (function () {
    ...
    var translations = {
      ru: {
        ...
        'price-t2-f1': '1 видео (30–60 сек) + 2 варианта монтажа',
        'price-t2-f2': 'Съёмка пары или соло на выбор',
        'price-t2-f3': 'Права на рекламу — 3 месяца',
        'price-t2-f4': 'Срок: 7–10 дней',
        'price-t3-tier': 'Premium',
        'price-t3-desc': 'Для люксовых брендов, отелей и travel',
        'price-t3-f1': 'Hero-видео (45–90 сек) + 2–3 reels',
        'price-t3-f2': 'Съёмка пары, атмосферный lifestyle',
        'price-t3-f3': 'Drone-съёмка (по локации)',
        'price-t3-f4': 'Права на рекламу — 6 месяцев',
        'price-t3-f5': 'Срок: 10–14 дней',
        ...
        'price-e1': '📸 Фото-сет (10–15 кадров) — от 10 000 ₽',
        'price-e2': '⏱ Срочность до 3 дней — +40%',
        'price-e4': '♾ Вечные права на рекламу — +100%'
      },
      en: {
        'nav-about': 'About',
        'nav-brands': 'Clients',
        ...
        'price-t2-f1': '1 video (30–60 sec) + 2 edit versions',
        'price-t2-f2': 'Couple or solo shoot — your choice',
        'price-t2-f3': 'Ad usage rights — 3 months',
        'price-t2-f4': 'Delivery: 7–10 days',
        'price-t3-tier': 'Premium',
        'price-t3-desc': 'For luxury brands, hotels & travel',
        'price-t3-f1': 'Hero video (45–90 sec) + 2–3 reels',
        'price-t3-f2': 'Couple shoot, atmospheric lifestyle',
        'price-t3-f3': 'Drone footage (location permitting)',
        'price-t3-f4': 'Ad usage rights — 6 months',
        'price-t3-f5': 'Delivery: 10–14 days',
        ...
        'price-e1': '📸 Photo set (10–15 shots) — from $130',
        'price-e2': '⏱ Rush delivery (3 days) — +40%',
        'price-e4': '♾ Perpetual ad rights — +100%'
      }
    };
