  ...
  (function () {
    ...
    var translations = {
      ru: {
        ...
        'stats-desc-gorbacheva': 'Коллаборация для трех сообществ, рилс набрал 4.3 млн, более 2000 тыс. коментариев и каждый получил по несколько тысяч новой аудитории.',
      ...
      en: {
        ...
        'stats-desc-gorbacheva': 'Collaboration for three communities, the reel gained 4.3M views, over 2,000 comments and each received several thousand new audience members.',
